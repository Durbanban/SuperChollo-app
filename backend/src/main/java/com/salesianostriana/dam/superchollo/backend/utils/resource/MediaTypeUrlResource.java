package com.salesianostriana.dam.superchollo.backend.utils.resource;

import com.salesianostriana.dam.superchollo.backend.service.storage.StorageException;
...
public class MediaTypeUrlResource extends UrlResource {
    ...
    public String getType() {
        ...
        try {
            ...
            throw new StorageException("Error al intentar obtener el tipo MIME", ex);
        }
    }
}
